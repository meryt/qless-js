...
describe('Client', function() {
    ...
    describe('job()', function() {
        it('should retrieve a job by jid', function(done) {
            client.queue('bar').put('BarJob', {}, {'jid': 'mybarjid'}, function() {
                client.job('mybarjid', function(result) {
                    assert.equal(result.jid, 'mybarjid');
                    done();
                })
            })
        })
